...
class SKConv(nn.Module):
    def __init__(self, in_channels, M=2, G=32, r=16, stride=1, L=32):
        """ Constructor
        Args:
        ...
        for i in range(M):
            self.convs.append(
                nn.Sequential(
                    nn.Conv2d(in_channels, in_channels, kernel_size=3, stride=stride, padding=1+i, dilation=1+i, groups=G, bias=False),
